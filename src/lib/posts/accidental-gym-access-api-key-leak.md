...
categories: 
  ...
  - "vulnerability"
  - "bug bounty"
coverImage: "/images/hacker_cover.png"
excerpt: "A quick writeup on how I accidentally compromised a major gym SaaS provider by poking at legacy API endpoints."
---
...
![Default page on website](/images/login_page.png)
...
![JS showing the JQuery getsettings call](/images/getsettings_js.png)

I sent the request via Burp Repeater without any session cookies to see what I'd get.


![Burp Suite Request showing the unauthenticated call](/images/getsettings.png)
